...
function ImageCard(){
    return (
        ...
        <div>
            <div style={{width:"100%",height:"60px",backgroundColor:"MediumSeaGreen"}}>
                <Text  fontWeight={"bold"} fontSize='lg' > SINGLES'S DAY:GET UPTO 90% OFF </Text>
                <Text  fontWeight={"bold"} fontSize='sm' > <u>Ends 11/11</u> </Text>

            </div>
      <div>

     
 <Image width={"100%"} height="600px" cursor={"pointer"}
