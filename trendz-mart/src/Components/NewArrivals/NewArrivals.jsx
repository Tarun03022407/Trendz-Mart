  ...
  const settings = {
   ...
   return  (
      ...
      <div className="newArrivals">
         <div>
            <Text letterSpacing=".5px" fontFamily="Montserrat,sansSerif"  fontSize="28px" lineHeight="28px" marginBottom="23px">  NEW ARRIVALS</Text>
...
//       <Image src={el.url} alt="product-image" />
